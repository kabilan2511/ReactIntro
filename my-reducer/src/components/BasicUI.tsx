...
const BasicUi = () => {
  return (
    <>
      ...
      <p><a href="https://www.google.com">Opens the document in the same window/tab as it was clicked</a></p>
      <p><a href="https://www.google.com" target="_self">Opens the document in the same window/tab as it was clicked</a></p>
      <p><a href="https://www.google.com" target="_blank" rel="noreferrer">Opens the document in a new window or tab</a></p>
      <p><a href="https://www.google.com" target="_parent">Opens the document in the parent frame</a></p>
      <p><a href="https://www.google.com" target="_top"> Opens the document in the full body of the window</a></p>
